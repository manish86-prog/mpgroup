...
class App extends Component {
  ...
  onFormSubmit(data) {
    ...
    if(this.state.isEditProduct){
      apiUrl = 'http://localhost/dev/blogger/reactapi/editProduct';
    } else {
      apiUrl = 'http://localhost/dev/blogger/reactapi/createProduct';
    }
  ...
  editProduct = productId => {
    ...
    const apiUrl = 'http://localhost/dev/blogger/reactapi/getProduct';
